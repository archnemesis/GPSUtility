...
**
** Created: Thu Sep 30 09:34:57 2010
...
static const char qt_meta_stringdata_ConnectionDialog[] = {
    "ConnectionDialog\0\0"
    "on_chkLoggingEnabled_stateChanged(int)\0"
    "on_btnChooseLogFile_clicked()\0"
...
int ConnectionDialog::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: on_chkLoggingEnabled_stateChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: on_btnChooseLogFile_clicked(); break;
