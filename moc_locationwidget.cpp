...
**
** Created: Thu Sep 30 09:34:55 2010
...
static const char qt_meta_stringdata_LocationWidget[] = {
    "LocationWidget\0"
};

const QMetaObject LocationWidget::staticMetaObject = {
    { &QDockWidget::staticMetaObject, qt_meta_stringdata_LocationWidget,
      qt_meta_data_LocationWidget, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &LocationWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_LocationWidget))
